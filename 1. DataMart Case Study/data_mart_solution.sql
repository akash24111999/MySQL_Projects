...
SELECT
  week_date,
  ## adding week_number as the second column:
  week(week_date) AS week_number,
  ## adding month_number as the third column:
  month(week_date) AS month_number,
  ## adding calendar_year as the fourth column with values between 2018, 2019 or 2020:
  year(week_date) AS calendar_year,
  region,
  platform,
  ## Converting "null" to "Unknown" in the segment column:
  CASE
    WHEN segment = 'null' THEN 'Unknown'
    ELSE segment
    END AS segment,
  ## Converting segment column right values to their respective age_band:
  CASE
    ...
    ELSE 'Unknown'
    END AS age_band,
  ## Converting segment column left values to their respective demographic:
  CASE
